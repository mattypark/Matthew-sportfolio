# Graph Report - matthewportfolio  (2026-07-04)

## Corpus Check
- 70 files · ~1,036,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 411 nodes · 470 edges · 44 communities (33 shown, 11 thin omitted)
...
### Community 4 - "App.jsx"
Cohesion: 0.12
Nodes (18): App(), Cursor(), detectEnabled(), Gate(), LabelsPage(), NUTRITION, tilt(), LifePage() (+10 more)

### Community 5 - "RightPanel.jsx"
Cohesion: 0.16
Nodes (14): ArrowCurve(), CircleScribble(), Spiral(), Squiggle(), Star(), strokeProps(), Sun(), useDrawOnView() (+6 more)
...
Cohesion: 0.17
Nodes (11): Asian-Korean, born in Kentucky., Currently building:, Design direction (this sandbox), Develop, Eyes set on:, Matthew Park — Portfolio (TESTING SANDBOX), Off the keyboard:, Stack (+3 more)
...
## Knowledge Gaps
- **196 isolated node(s):** `name`, `version`, `type`, `dev`, `build` (+191 more)

...
export default function SongsOfTheWeek() {
  ...
  return (
    <section id="songs" className="relative gutter pt-[18vh] pb-[6vh]">
      ...
      <article className="border-t border-paper/15 pt-8 flex flex-col items-center text-center">
        <div className="flex items-center justify-center gap-3 font-mono text-[10px] tracking-[0.24em] uppercase text-paper/45 mb-4">
        ...
        >
          <div
            ref={titleRef}
            className="font-display text-[clamp(36px,6.4vw,116px)] leading-[1] text-paper select-none mx-auto"
            style={{
              whiteSpace: 'nowrap',
              overflow: 'hidden',
              textOverflow: 'clip',
        ...
        <div className="mt-12 flex flex-col items-center font-mono text-[11px] tracking-[0.18em] uppercase text-paper/70">

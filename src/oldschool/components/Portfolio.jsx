...
const Portfolio = () => {
  ...
  const timelineEvents = [
    ...
    {
      date: '07.31.26',
      description: 'Hits 20K followers on Instagram',
      link: null,
    },
    {
      date: '07.25.26',
    ...
    {
      date: '07.06.26',
      description: 'Hits 10K followers on Instagram',
      link: null,
    },
    {
      date: '05.07.26',
      description: 'Finishes AP tests',
      link: null,
    },
    {
      date: '04.18.26',
      description: 'Starts on a nonprofit',
      link: null,
    },
    {
      date: '04.17.26',
      description: 'Gets into Stanford ASES Launchpad Program',
      link: null,
    },
    {
      // PLACEHOLDER DATE — "around April", exact day still to be confirmed
      date: '04.12.26',
      description: 'Posts his first Instagram video',
      link: null,
    },
    {
      date: '03.25.26',
